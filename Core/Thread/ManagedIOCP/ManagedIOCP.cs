...
#pragma warning restore 420
        ...
        private LockFree.Queue<T> _qObjects = new LockFree.Queue<T>();
        private LockFree.Queue<IOCPHandle<T>> _qIOCPHandle = new LockFree.Queue<IOCPHandle<T>>();
#if (DYNAMIC_IOCP)
        private LockFree.Queue<T> _qSuspendedIOCPHandle = new LockFree.Queue<T>(100);
#endif
