...
namespace GameData
{
    public sealed class FontFileCooker : IDataFile, ISignature
    {
        private string _srcFilename;
        private string _dstFilename;
        private Dependency _dependency;

        public FontFileCooker() : this(string.Empty, string.Empty)
        {
        }
        public FontFileCooker(string filename) : this(filename, filename)
        {
        }

        private FontFileCooker(string srcFilename, string dstFilename)
        {
        ...
        {
            GameCore.BinaryWriter.Write(stream,"FontFileCooker");
        ...
        {
            if (dc is not FontFileCooker cc) return;
